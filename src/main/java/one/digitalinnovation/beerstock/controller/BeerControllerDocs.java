...
//     @ApiOperation(value = "Returns a list of beers registered in the system according to their expiration dates")
//    @ApiResponses(value = {
//            @ApiResponse(code = 200, message = "List of all beers registered in the system according to their validity"),
//    })
//    List<BeerDTO> findByDateValidity(@PathVariable String minDate, String maxDate) throws BeerNotFoundException;
